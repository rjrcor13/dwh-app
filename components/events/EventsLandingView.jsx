...
export default function EventsLandingView() {
    ...
    return (
        <main className="min-h-screen bg-slate-50 selection:bg-blue-100/50" role="main" aria-label="Events Overview">
            {/* Hero Section */}
            <section className="relative bg-white pt-24 pb-20 overflow-hidden" aria-labelledby="events-heading">
                ...
                <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-indigo-500/5 rounded-full blur-[100px] -ml-40 -mb-40 pointer-events-none" aria-hidden="true" />
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
                    ...
                    >
                        ...
                        <h1 id="events-heading" className="text-5xl md:text-7xl font-bold font-heading text-slate-900 mb-6 tracking-tight">
            ...
            {/* Categories Grid */}
            <section className="max-w-7xl mx-auto px-6 py-20" aria-label="Event Categories">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    {categories.map((category, idx) => (
                        <motion.div
                            ...
                            role="article"
                        >
                            <Link href={category.href} className="group block h-full focus:outline-none focus:ring-4 focus:ring-blue-200 rounded-3xl transition-shadow" aria-label={`View ${category.title}`}>
                                <div className={`h-full bg-white rounded-3xl p-8 border ${category.border} ${category.hoverBorder} shadow-lg shadow-slate-200/50 hover:shadow-xl hover:shadow-blue-900/5 transition-all duration-300 relative overflow-hidden`}>
                                    ...
                                    {/* Icon */}
                                    <div className={`w-14 h-14 rounded-2xl ${category.bg} ${category.color} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`} aria-hidden="true">
                                    ...
                                    <div className={`inline-flex items-center font-bold ${category.color} group-hover:translate-x-2 transition-transform duration-300`} aria-hidden="true">
            ...
            <section className="max-w-7xl mx-auto px-6 pb-24" aria-labelledby="newsletter-heading">
                <div className="bg-primary rounded-3xl p-12 md:p-16 text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        <h2 id="newsletter-heading" className="text-3xl md:text-4xl font-bold text-white mb-6">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            <Link href="/contact" tabIndex={-1}>
                                <Button size="lg" className="bg-white text-primary hover:bg-blue-50 border-0 font-bold h-14 px-8 rounded-xl shadow-lg shadow-black/20 focus:ring-4 focus:ring-white/50">
                                    Contact Us
                                </Button>
                            </Link>
                            <Link href="/doctors" tabIndex={-1}>
                                <Button size="lg" variant="outline" className="bg-transparent text-white border-white/30 hover:bg-white/10 font-bold h-14 px-8 rounded-xl focus:ring-4 focus:ring-white/50">
                                    Find a Doctor
                                </Button>
                            </Link>
                        </div>
