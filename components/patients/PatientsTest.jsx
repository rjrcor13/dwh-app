...
const PatientsTest = () => {
	...
	const DepartmentContent = ({ department }) => (
		<Card className="shadow-none border-none h-full flex flex-col text-justify">
			<CardHeader className="">
				<CardTitle className="text-3xl font-bold text-primary flex items-center gap-3">
					{department.icon && (
						<department.icon className="w-9 h-9 text-primary" />
					)}
					{department.name}
				</CardTitle>
			...
			<CardContent className="flex-grow space-y-6 text-gray-700">
