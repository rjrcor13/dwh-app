        ...
        <main className="min-h-screen bg-slate-50/50 selection:bg-blue-100/50 relative overflow-hidden font-sans pb-32 pt-24" aria-label="Contact Us Page">
            ...
            <div className="relative z-10 max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 pt-12">
                ...
                <PageHeader
                    ...
                    description="Have questions or need assistance? Reach out to our team. We are committed to providing you with the best compassionate care."
                />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    <div className="space-y-8">
                        <section aria-label="Contact Information">
                            <h2 className="text-2xl font-bold text-slate-900 mb-8 px-2">Contact Information</h2>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                {contactInfo.map((info, idx) => (
                                    <motion.div
                                        ...
                                        className="h-full"
                                    >
                                        <GlassCard className="p-6 h-full flex flex-col items-start gap-4" hoverEffect={true}>
                                            <div className={`w-12 h-12 ${info.bg} ${info.color} rounded-2xl flex items-center justify-center`}>
                        ...
                        <section aria-label="Location Map">
                            <GlassCard className="p-4 h-80 relative flex items-center justify-center p-0 overflow-hidden" hoverEffect={false}>
                                {/* In a real app, embed Google Maps iframe here */}
                                <div className="absolute inset-0 bg-slate-100/50 flex items-center justify-center flex-col gap-4">
                        ...
                        <GlassCard className="p-8 md:p-12 h-full">
                            ...
                            <form className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            type="text"
                                            id="firstName"
                                            className="w-full px-6 py-4 rounded-2xl bg-white/50 border border-slate-200 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all outline-none font-medium"
                                            placeholder="John"
                                        />
                                    </div>
                                    <div className="space-y-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <select
                                        id="subject"
                                        className="w-full px-6 py-4 rounded-2xl bg-white/50 border border-slate-200 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all outline-none font-medium text-slate-600 appearance-none"
                                    >
                                ...
                                <div className="space-y-2">
                                    ...
                                    <textarea
                                        id="message"
                                        rows={5}
                                        className="w-full px-6 py-4 rounded-2xl bg-white/50 border border-slate-200 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all outline-none font-medium resize-none"
